...
public class ServicesServiceLocator extends org.apache.axis.client.Service implements connection.ServicesService {
    ...
    private java.lang.String services_address = "http://localhost:8080/Ebay/services/services";
    ...
    public connection.Services getservices() throws javax.xml.rpc.ServiceException {
    ...
    public connection.Services getservices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            connection.ServicesSoapBindingStub _stub = new connection.ServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (connection.Services.class.isAssignableFrom(serviceEndpointInterface)) {
                connection.ServicesSoapBindingStub _stub = new connection.ServicesSoapBindingStub(new java.net.URL(services_address), this);
                _stub.setPortName(getservicesWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://connection", "servicesService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://connection", "services"));
        }
